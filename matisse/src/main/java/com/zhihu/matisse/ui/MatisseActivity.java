...
public class MatisseActivity extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBackHome = findViewById(R.id.mis_back_home);
        ...
        if (requestCode == REQUEST_CODE_PREVIEW) {
            ...
            if (data.getBooleanExtra(BasePreviewActivity.EXTRA_RESULT_APPLY, false)) {
                ...
                if (mSpec.isCrop && mSpec.maxSelectable == 1) {
                    result.setClass(this, MatisseCropActivity.class);
                    startActivityForResult(result, REQUEST_CODE_CROP);
                } else {
            ...
            Intent result = new Intent();
            ArrayList<Uri> selectedUris = (ArrayList<Uri>) Matisse.obtainResult(data);
            ArrayList<String> selectedPaths = (ArrayList<String>) Matisse.obtainPathResult(data);
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.mis_back_home) {
            onBackPressed();
        }
    }
